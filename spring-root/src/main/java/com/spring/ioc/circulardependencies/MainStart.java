...
public class MainStart {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 已经加载循环依赖
        String beanName="com.spring.ioc.circulardependencies.InstanceA";
    ...
    private static Object getBean(String beanName) throws Exception {
        ...
        ObjectFactory factory= () -> {
            return getEarlyBeanReference(beanInstanc,beanName);
...
//            return beanPostProcessor.getEarlyBeanReference(beanInstanc,beanName);
    ...
    private  static  Object getEarlyBeanReference(Object bean, String beanName){
